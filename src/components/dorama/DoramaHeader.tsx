...
import DoramaPlaylists from './DoramaPlaylists';
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex flex-wrap gap-3 pt-4">
                  <button
                    ...
                    className="group bg-white/95 hover:bg-white text-purple-700 hover:text-purple-800 px-5 py-2.5 rounded-xl font-medium transition-all duration-300 flex items-center gap-2 shadow-md hover:shadow-white/25 transform hover:scale-105 border border-white/50 text-sm"
                  >
